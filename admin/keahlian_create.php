                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Keahlian</h3>
                        </div>
                        <div class="form-input p-3">
                            <form action="proses/proses_keahlian_create.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_keahlian" id="nama_keahlian" placeholder="Nama Keahlian">
                                </div>
                                <br>
