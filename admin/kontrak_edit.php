...
<body>
    ...
    <div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-boxed">
        ...
        <main id="main-container">
            <!-- Page Content -->
            <div class="content">
                <a class="btn btn-success" href="kontrak.php">Kembali</a><br><br>
                <!-- Dynamic Table Full -->
                <div class="block">
                    ...
                    <div class="form-input p-3">
                        <form action="proses/proses_kontrak_update.php" method="POST" enctype="multipart/form-data">
                            <?php
                                    $id_kontrak = $_GET['id_kontrak'];
                                    $data = mysqli_query($conn,"SELECT * FROM kontrak WHERE id_kontrak=$id_kontrak");
                                    while($kontrak = mysqli_fetch_array($data)) { ?>
                            <div class="form-group mt-2">
                                <label for="durasi_kontrak">Durasi Kontrak</label>
                                <select name="durasi_kontrak" id="durasi_kontrak" class="form-control">
                                    <option value="<?php echo $kontrak['DURASI_KONTRAK']?>">
                                        <?php echo $kontrak['DURASI_KONTRAK'] ?> Tahun</option>
                            ...
                            <div class="form-group mt-2">
                                <label for="tanggal">Tanggal Kontrak</label>
                                <input type="date" class="form-control" id="tanggal" name="tanggal"
                                    value="<?php echo $kontrak['TANGGAL'] ?>">
                            </div>
                            <input type="text" hidden class="form-control" id="id_kontrak" name="id_kontrak"
                                value="<?php echo $kontrak['ID_KONTRAK'] ?>">
    ...
    <script type="text/javascript">
        function auto_fill() {
            ...
            $.ajax({
                method: "GET",
                url: 'proses/proses_ajax_kontrak.php?id_prt=' + id_prt,
                data: "id_prt=" + id_prt,
