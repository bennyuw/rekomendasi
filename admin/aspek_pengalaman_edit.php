...
<body>
    ...
    <div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-boxed">
        ...
        <main id="main-container">
            <!-- Page Content -->
            <div class="content">
                <a class="btn btn-success" href="aspek_pengalaman.php">Kembali</a><br><br>
                <!-- Dynamic Table Full -->
                <div class="block">
                    ...
                    <div class="form-input p-3">
                        <form action="proses/proses_aspek_pengalaman_update.php" method="POST"
                            enctype="multipart/form-data">

                            <?php
                                    $id_nilai_pengalaman = $_GET['id_nilai_pengalaman'];
                                    $data = mysqli_query($conn,"SELECT * FROM nilai_pengalaman WHERE id_nilai_pengalaman=$id_nilai_pengalaman");
                                    while($nilai_pengalaman = mysqli_fetch_array($data)) { ?>
                            <div class="form-group">
                                <label for="nilai_p1">Nilai P1</label>
                                <input type="number" class="form-control" name="nilai_p1" id="nilai_p1"
                                    placeholder="Nilai P1" value="<?php echo $nilai_pengalaman['NILAI_P1'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="nilai_p2">Nilai P2</label>
                                <input type="number" class="form-control" name="nilai_p2" id="nilai_p2"
                                    placeholder="Nilai P2" value="<?php echo $nilai_pengalaman['NILAI_P2'] ?>">
                            </div>

                            <input type="text" class="form-control" name="id_nilai_pengalaman" id="id_nilai_pengalaman"
                                placeholder="Nilai P2" hidden value="<?php echo $nilai_pengalaman['ID_NILAI_PENGALAMAN'] ?>">
    ...
    <script type="text/javascript">
        function auto_fill() {
            ...
            $.ajax({
                method: "GET",
                url: 'proses/proses_ajax_pengalaman.php?id_prt=' + id_prt,
                data: "id_prt=" + id_prt,
