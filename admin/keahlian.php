    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-boxed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                    <a class="btn btn-success" href="keahlian_create.php">Tambah</a><br><br>
                    <!-- Dynamic Table Full -->
                    <div class="block">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-vcenter">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    $data = mysqli_query($conn, "select * from keahlian");
                                    while ($d = mysqli_fetch_array($data)) {
                                    ?>
                                        <tr>
                                            <td class="text-center"><?php echo $no++; ?></td>
                                            <td class="text-center"><?php echo $d['NAMA_PRT']; ?></td>
                                            <td class="text-center"><?php echo $d['NAMA_KEAHLIAN']; ?></td>
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="keahlian_edit.php?id_keahlian=<?php echo $d['ID_KEAHLIAN'] ?>">
                                                        <button type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Ubah">
                                                            <i class="fa fa-pencil"></i>
                                                        </button>
                                                    </a>
                                                    <a href='proses/proses_keahlian_delete.php?id_keahlian=<?php echo $d['ID_KEAHLIAN'] ?>'>
