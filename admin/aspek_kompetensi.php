...
if (!$_SESSION['id_user'] == "") {  ?>
    ...
    <head>
        ...
        <title>ADMIN - ASPEK KOMPETENSI</title>
                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Profil Aktual PRT</h3>
                        </div>
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-vcenter">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    $data = mysqli_query($conn, "SELECT prt_baru.ID_PRT, prt_baru.NAMA_PRT, tes_pengetahuan.NILAI_PENGETAHUAN, tes_keterampilan.NILAI_KETERAMPILAN, tes_sikap.NILAI_SIKAP, (prt_baru.PENGALAMAN_BEKERJA + kontrak.DURASI_KONTRAK) AS 'NILAI_LAMA_BEKERJA', sertifikat_pelatihan.JUMLAH_SERTIFIKAT_PELATIHAN FROM prt_baru JOIN tes_pengetahuan ON prt_baru.ID_PRT = tes_pengetahuan.ID_PRT JOIN tes_keterampilan ON prt_baru.ID_PRT = tes_keterampilan.ID_PRT JOIN tes_sikap ON prt_baru.ID_PRT = tes_sikap.ID_PRT JOIN kontrak ON prt_baru.ID_PRT = kontrak.ID_PRT JOIN sertifikat_pelatihan ON prt_baru.ID_PRT = sertifikat_pelatihan.ID_PRT");
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-none d-sm-table-cell">
                                                <?php
                                                if ($d['NILAI_PENGETAHUAN'] <= 20) {
                                                    echo 1; ?>
                                                    <input name="nilai_k1" hidden value="1">
                                                <?php
                                                } else if ($d['NILAI_PENGETAHUAN'] <= 40) {
                                                    echo 2; ?>
                                                    <input name="nilai_k1" hidden value="2">
                                                <?php
                                                } else if ($d['NILAI_PENGETAHUAN'] <= 60) {
                                                    echo 3; ?>
                                                    <input name="nilai_k1" hidden value="3">
                                                <?php
                                                } else if ($d['NILAI_PENGETAHUAN'] <= 80) {
                                                    echo 4; ?>
                                                    <input name="nilai_k1" hidden value="4">
                                                <?php
                                                } else if ($d['NILAI_PENGETAHUAN'] <= 100) {
                                                    echo 5; ?>
                                            ...
                                            <td class="d-none d-sm-table-cell">
                                                <?php
                                                if ($d['NILAI_KETERAMPILAN'] <= 20) {
                                                    echo 1; ?>
                                                    <input name="nilai_k2" hidden value="1">
                                                <?php
                                                } else if ($d['NILAI_KETERAMPILAN'] <= 40) {
                                                    echo 2; ?>
                                                    <input name="nilai_k2" hidden value="2">
                                                <?php
                                                } else if ($d['NILAI_KETERAMPILAN'] <= 60) {
                                                    echo 3; ?>
                                                    <input name="nilai_k2" hidden value="3">
                                                <?php
                                                } else if ($d['NILAI_KETERAMPILAN'] <= 80) {
                                                    echo 4; ?>
                                                    <input name="nilai_k2" hidden value="4">
                                                <?php
                                                } else if ($d['NILAI_KETERAMPILAN'] <= 100) {
                                                    echo 5; ?>
                    ...
                    <a class="btn btn-success" href="aspek_kompetensi_create.php">Tambah</a><br><br>
                    <!-- Dynamic Table Full -->
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Aspek Kompetensi</h3>
                        </div>
                        <div class="table-responsive">
                            <!-- DataTables init on table by adding .js-dataTable-full class, functionality initialized in js/pages/be_tables_datatables.js -->
                            <table class="table table-striped table-vcenter">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="d-sm-table-cell">Nilai Keterampilan</th>
                                        <th class="d-sm-table-cell">Nilai Sikap Kerja</th>
                                        <th class="text-center">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $no = 1;
                                    $data = mysqli_query($conn, "select * from nilai_kompetensi");
                                    while ($d = mysqli_fetch_array($data)) {
                                    ?>
                                        <tr>
                                            <td class="text-center"><?php echo $no++; ?></td>
                                            <td class="text-center"><?php echo $d['NAMA_PRT']; ?></td>
                                            <td class="text-center"><?php echo $d['NILAI_K1']; ?></td>
                                            <td class="text-center"><?php echo $d['NILAI_K2']; ?></td>
                                            <td class="text-center"><?php echo $d['NILAI_K3']; ?></td>
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="aspek_kompetensi_edit.php?id_nilai_kompetensi=<?php echo $d['ID_NILAI_KOMPETENSI'] ?>">
                                                        <button type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Ubah">
                                                            <i class="fa fa-pencil"></i>
                                                        </button>
                                                    </a>
                                                    <a href='proses/proses_aspek_kompetensi_delete.php?id_nilai_kompetensi=<?php echo $d['ID_NILAI_KOMPETENSI'] ?>'>
