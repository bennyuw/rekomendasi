    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-boxed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                    <a class="btn btn-success" href="sertifikat_pelatihan_create.php">Tambah</a><br><br>
                    <!-- Dynamic Table Full -->
                    <div class="block">
                            ...
                            <table class="table table-striped table-vcenter">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Jumlah Sertifikat/Pelatihan</th>
                                        <th class="d-sm-table-cell">Deskripsi</th>
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    $data = mysqli_query($conn, "select * from sertifikat_pelatihan");
                                    while ($d = mysqli_fetch_array($data)) {
                                    ?>
                                        <tr>
                                            <td class="text-center"><?php echo $no++; ?></td>
                                            <td class="text-center"><?php echo $d['NAMA_PRT']; ?></td>
                                            <td class="text-center"><?php echo $d['JUMLAH_SERTIFIKAT_PELATIHAN']; ?></td>
                                            <th class="d-sm-table-cell"><?php echo $d['DESKRIPSI']; ?></td>
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="sertifikat_pelatihan_edit.php?id_sertifikat_pelatihan=<?php echo $d['ID_SERTIFIKAT_PELATIHAN']?>">
                                                    <button type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Ubah">
                                                        <i class="fa fa-pencil"></i>
                                                    </button>
                                                    </a>
                                                    <a href='proses/proses_sertifikat_delete.php?id_sertifikat_pelatihan=<?php echo $d['ID_SERTIFIKAT_PELATIHAN'] ?>'>
