    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-boxed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                    <a class="btn btn-success" href="master_prt_baru_create.php">Tambah</a> <br><br>
                    <!-- Dynamic Table Full -->
                    <div class="block">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-vcenter">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    $data = mysqli_query($conn, "select * from prt_baru where STATUS_PRT = 1");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="d-none d-sm-table-cell"><?php
                                                                                if ($d['JKEL_PRT'] == 'L') {
                                                                                    echo 'Pria';
                                                                                } else if ($d['JKEL_PRT'] == 'P') {
                                                                                    echo 'Wanita';
                                                                                }
                                                                                ?></td>
                                            <td><?php echo $d['TL_PRT']; ?></td>

                                            <td><?php echo $d['ALAMAT_PRT']; ?></td>
                                            <td><?php echo $d['TELP_PRT']; ?></td>
                                            <td><?php echo $d['NO_KTP_PRT']; ?></td>
                                            <td><?php echo $d['NO_KK_PRT']; ?></td>
                                            
                                            <td>
                                                <?php if ($d['PENDIDIKAN_TERAKHIR'] == 1) { ?>
                                                    Tidak Sekollah
                                                <?php } else if ($d['PENDIDIKAN_TERAKHIR'] == 2) { ?>

                                                    SD
                                                <?php } else if ($d['PENDIDIKAN_TERAKHIR'] == 3) {  ?>

                                                    SMP
                                                <?php } else if ($d['PENDIDIKAN_TERAKHIR'] == 4) {  ?>
                                            ...
                                            <td>
                                                <?php if ($d['PENGALAMAN_BEKERJA'] == 0) { ?>
                                                    Tidak Ada
                                                <?php } else if ($d['PENGALAMAN_BEKERJA'] == 1) { ?>

                                                    1 Tahun
                                                <?php } else if ($d['PENGALAMAN_BEKERJA'] == 2) { ?>
                                                    2 Tahun
                                                <?php } else if ($d['PENGALAMAN_BEKERJA'] == 3) {  ?>

                                                    3 Tahun
                                                <?php } else if ($d['PENGALAMAN_BEKERJA'] == 4) {  ?>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href='master_prt_baru_edit.php?id_prt=<?php echo $d['ID_PRT'] ?>'>
                                                        <button type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Ubah">
                                                            <i class="fa fa-pencil"></i>
                                                        </button>
                                                    </a>
                                                    <a href='proses/proses_prt_baru_delete.php?id_prt=<?php echo $d['ID_PRT'] ?>'>
