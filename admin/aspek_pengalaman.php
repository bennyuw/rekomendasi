...
if (!$_SESSION['id_user'] == "") {  ?>
    ...
    <head>
        ...
        <title>ADMIN - ASPEK PENGALAMAN</title>
        ...
        <div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-boxed">
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <a class="btn btn-success" href="aspek_pengalaman_create.php">Tambah</a><br><br>
                    <!-- Dynamic Table Full -->
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Aspek Pengalaman</h3>
                        </div>
                        <div class="table-responsive">
                            <!-- DataTables init on table by adding .js-dataTable-full class, functionality initialized in js/pages/be_tables_datatables.js -->
                            <table class="table table-striped table-vcenter">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Nilai Lama Bekerja</th>
                                        <th class="d-sm-table-cell">Nilai Sertifikat/Pelatihan</th>
                                        <th class="text-center">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $no = 1;
                                    $data = mysqli_query($conn, "select * from nilai_pengalaman");
                                    while ($d = mysqli_fetch_array($data)) {
                                    ?>
                                        <tr>
                                            <td class="text-center"><?php echo $no++; ?></td>
                                            <td class="text-center"><?php echo $d['NAMA_PRT']; ?></td>
                                            <td class="text-center"><?php echo $d['NILAI_P1']; ?></td>
                                            <td class="text-center"><?php echo $d['NILAI_P2']; ?></td>
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="aspek_pengalaman_edit.php?id_nilai_pengalaman=<?php echo $d['ID_NILAI_PENGALAMAN'] ?>">
                                                        <button type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Ubah">
                                                            <i class="fa fa-pencil"></i>
                                                        </button>
                                                    </a>
                                                    <a href='proses/proses_aspek_pengalaman_delete.php?id_nilai_pengalaman=<?php echo $d['ID_NILAI_PENGALAMAN'] ?>'>
