                ...
                <div class="content">
                    ...
                    <div class="block">
                        ...
                        <div class="form-input p-3">
                            <form action="proses/proses_aspek_pengalaman_create.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="nilai_p1" id="nilai_p1" placeholder="Nilai P1">
                                </div>
                                <div class="form-group">
                                    <label for="nilai_p2">Nilai P2</label>
                                    <input type="number" class="form-control" name="nilai_p2" id="nilai_p2" placeholder="Nilai P2">
                                </div>
                                <br>
