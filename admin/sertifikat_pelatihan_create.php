                ...
                <div class="content">
                    ...
                    <div class="block">
                        ...
                        <div class="form-input p-3">
                            <form action="proses/proses_sertifikat_create.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="jumlah_sertifikat_pelatihan" id="jumlah_sertifikat_pelatihan" placeholder="Jumlah Sertifikat Pelatiha">
                                </div>
                                <div class="form-group">
