                ...
                <div class="content">
                    ...
                    <div class="block">
                        ...
                        <div class="form-input p-3">
                            <form action="proses/proses_aspek_kompetensi_create.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="nilai_k1" id="nilai_k1" placeholder="Nilai K1">
                                </div>
                                <div class="form-group">
                                    <label for="nilai_k2">Nilai K2</label>
                                    <input type="number" class="form-control" name="nilai_k2" id="nilai_k2" placeholder="Nilai K2">
                                </div>
                                <div class="form-group">
                                    <label for="nilai_k3">Nilai K3</label>
                                    <input type="number" class="form-control" name="nilai_k3" id="nilai_k3" placeholder="Nilai K3">
                                </div>
                                <br>
