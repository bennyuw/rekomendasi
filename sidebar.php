        ...
        <div class="sidebar-content">
            ...
            <div class="content-side content-side-full">
                <ul class="nav-main">
                    ...
                    <li>
                        <a href="lihat_prt.php">
                            <i class="si si-users"></i>
                            <span class="sidebar-mini-hide">Pemilihan PRT</span>
                        </a>
                    </li>
                    <li>
                        <a href="permintaan_prt.php">
                            <i class="si si-user-follow"></i>
                            <span class="sidebar-mini-hide">Permintaan PRT</span>
                        </a>
                    </li>
                    <!-- <li>
                        <a href="kontrak_kerja.php">
                            <i class="si si-note"></i>
                            <span class="sidebar-mini-hide">Kontrak Kerja</span>
                        </a>
                    </li>
                    <li>
                        <a href="layanan.php">
                            <i class="si si-earphones-alt"></i>
                            <span class="sidebar-mini-hide">Layanan</span>
                        </a>
                    </li> -->
                </ul>
            </div>
