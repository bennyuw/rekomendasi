                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Permintaan Pekerja Rumah Tangga</h3>
                        </div>
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Nama Majikan</th>
                                        <th class="d-none d-sm-table-cell">Nama PRT</th>
                                        <th class="d-none d-sm-table-cell">Tanggal Permintaan</th>
                                ...
                                <tbody>
                                    ...
                                    $data = mysqli_query($conn, "SELECT permintaan.ID_PERMINTAAN as ID, permintaan.TGL_PERMINTAAN as TANGGAL , permintaan.STATUS_PERMINTAAN as STATUS_PERMINTAAN, majikan.NAMA_MAJIKAN as MAJIKAN, prt.NAMA_PRT as PRT from permintaan 
                                    JOIN majikan ON permintaan.ID_MAJIKAN = majikan.ID_MAJIKAN 
                                    JOIN prt ON permintaan.ID_PRT = prt.ID_PRT WHERE majikan.ID_MAJIKAN='$id_majikan'");
                                    while ($row = mysqli_fetch_array($data)) {
                                    ?>
                                        <tr>
                                            <td class="text-center"><?php echo $no++; ?></td>
                                            <td><?php echo $row['MAJIKAN']; ?></td>
                                            <td class="d-none d-sm-table-cell"><?php echo $row['PRT']; ?></td>
                                            <td class="d-none d-sm-table-cell"><?php echo $row['TANGGAL']; ?></td>
                                            <td class="text-center">
                                                <span class="badge badge-warning">
                                                    <?php
                                                    if ($row['STATUS_PERMINTAAN'] == 0) {
                                                        echo 'Menunggu Konfirmasi';
                                                    } else if ($row['STATUS_PERMINTAAN'] == 1) {
